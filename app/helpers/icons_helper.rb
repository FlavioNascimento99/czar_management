# Inline Lucide icons (https://lucide.dev, ISC license), 24x24 viewBox, stroke-based.
module IconsHelper
  ICONS = {
  ...
  # Decorative by default (aria-hidden); pass label: for a standalone meaningful icon.
  def icon(name, size: 16, label: nil, css: nil)
    a11y = label ? { role: "img", "aria-label": label } : { "aria-hidden": "true" }
    tag.svg(
      ICONS.fetch(name.to_s).html_safe,
      xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: size, height: size,
      fill: "none", stroke: "currentColor", "stroke-width": "1.75",
      "stroke-linecap": "round", "stroke-linejoin": "round",
      class: [ "saas-icon-svg", css ].compact.join(" "),
